...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  if (x>=y){ //si los dos son iguales devuelve x
    mayor = x
  }
  if (x<y){
    mayor = y
...
function esPrimo(numero) {
  ...
  primo = true // lo puse aca arriba sino no me andaba
  for (var i = 2; i<numero; i++){
    ...
    //else
     // primo = true -> comente esto porque me entraba siempre aca no se porque
  }
